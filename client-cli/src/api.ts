...
export const cmdConfigureDistributor = client.cmdConfigureDistributor;
export const cmdInstallLogisticsBot = client.cmdInstallLogisticsBot;
export const cmdUninstallLogisticsBot = client.cmdUninstallLogisticsBot;
export const cmdConfigureMechaLogistics = client.cmdConfigureMechaLogistics;

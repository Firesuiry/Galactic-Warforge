...
function buildGenericHint(): PlanetCommandHint {
  return {
    tone: "warning",
    title: "需要进一步检查建筑运行态",
    detail: "服务器未提供可展示的详细原因。",
  };
}

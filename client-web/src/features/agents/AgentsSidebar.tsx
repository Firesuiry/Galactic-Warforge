    ...
    <aside className="panel agent-sidebar">
      ...
      <div className="agent-sidebar__pane-switch" role="tablist" aria-label="智能体工作区导航">
        <Button
          ...
          className={props.activePane === 'channels' ? 'agent-sidebar__pane-button agent-sidebar__pane-button--active' : 'agent-sidebar__pane-button'}
        ...
        <Button
          ...
          className={props.activePane === 'members' ? 'agent-sidebar__pane-button agent-sidebar__pane-button--active' : 'agent-sidebar__pane-button'}
      ...
      {props.activePane === 'channels' ? (
        <>
          <div className="agent-sidebar__section-header">
            ...
            <Button variant="secondary" onClick={props.onToggleCreateChannel} type="button">
              新建频道
            </Button>
          </div>
          ...
          {props.showCreateChannel ? (
            <form className="agent-im__composer-card" onSubmit={props.onCreateChannel}>
              ...
              <Button variant="primary" disabled={props.fixtureMode} type="submit">创建频道</Button>
            </form>
          ) : null}
          ...
          <ul className="agent-sidebar__list">
            {channelConversations.map((conversation) => (
              <li key={conversation.id}>
                <Button
                  className={conversation.id === props.selectedConversationId ? 'agent-sidebar__list-button agent-sidebar__list-button--active' : 'agent-sidebar__list-button'}
        ...
        <>
          <div className="agent-sidebar__section-header">
            ...
            <Button variant="secondary" onClick={props.onOpenCreateMember} type="button">
              新建成员
            </Button>
          </div>
          ...
          <ul className="agent-sidebar__list">
            {props.agents.map((agent) => (
              <li key={agent.id}>
                <Button
                  className={agent.id === props.selectedAgentId ? 'agent-sidebar__list-button agent-sidebar__list-button--active' : 'agent-sidebar__list-button'}

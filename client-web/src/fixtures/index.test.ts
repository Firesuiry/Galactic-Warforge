...
describe('fixture fetch', () => {
  ...
  it('为行星场景接口按视窗裁剪地图内容', async () => {
    ...
    const response = await fetchFn(`${serverUrl}/world/planets/planet-1-1/scene?x=1&y=1&width=3&height=2&detail_level=tile&layers=terrain,fog,buildings,units,resources`, {
      headers: {
        Authorization: 'Bearer key_player_1',
      },
    });

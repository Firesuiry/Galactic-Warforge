    ...
    planets: [
      {
        ...
        kind: 'terrestrial',
        moon_count: 1,
        orbit: { distance_au: 1.0, period_days: 365, inclination_deg: 0 },
      },
      {
        ...
        discovered: true,
        kind: 'barren',
        orbit: { distance_au: 1.6, period_days: 580, inclination_deg: 2 },
      },
      {
        planet_id: 'planet-1-3',
        name: 'Vess',
        discovered: true,
        kind: 'gas_giant',
        moon_count: 3,
        orbit: { distance_au: 3.4, period_days: 2100, inclination_deg: 1 },
      },
      {
        planet_id: 'planet-1-4',
        discovered: false,
        kind: 'ice_giant',
        orbit: { distance_au: 6.1, period_days: 5200, inclination_deg: 4 },
      },
    ],
  },
  'sys-3': {
    ...
    planets: [
      {
        planet_id: 'planet-3-1',
        name: 'Cyra Prime',
        discovered: true,
        kind: 'lava',
        orbit: { distance_au: 0.6, period_days: 120, inclination_deg: 0 },
      },
      {
        planet_id: 'planet-3-2',
        discovered: false,
        kind: 'terrestrial',
        orbit: { distance_au: 1.4, period_days: 430, inclination_deg: 1 },
      },
    ],
  },
  'sys-5': {
    ...
    planets: [
      {
        planet_id: 'planet-5-1',
        name: 'Eos Minor',
        discovered: true,
        kind: 'oceanic',
        moon_count: 2,
        orbit: { distance_au: 1.2, period_days: 400, inclination_deg: 0 },
      },
    ],
  },
  'sys-7': {
    ...
    planets: [
      {
        planet_id: 'planet-7-1',
        name: 'Gora I',
        discovered: true,
        kind: 'barren',
        orbit: { distance_au: 0.3, period_days: 60, inclination_deg: 0 },
      },
      {
        planet_id: 'planet-7-2',
        discovered: false,
        kind: 'terrestrial',
        orbit: { distance_au: 0.8, period_days: 220, inclination_deg: 3 },
      },
      {
        planet_id: 'planet-7-3',
        discovered: false,
        kind: 'gas_giant',
        orbit: { distance_au: 2.2, period_days: 1400, inclination_deg: 1 },
      },
    ],
  },
  'sys-8': {
    ...
    planets: [
      {
        planet_id: 'planet-8-1',
        name: 'Helo Giant',
        discovered: true,
        kind: 'gas_giant',
        moon_count: 5,
        orbit: { distance_au: 2.8, period_days: 2600, inclination_deg: 0 },
      },
    ],
  },
  'sys-10': {
    ...
    planets: [
      {
        planet_id: 'planet-10-1',
        name: 'Jova I',
        discovered: true,
        kind: 'terrestrial',
        orbit: { distance_au: 1.1, period_days: 390, inclination_deg: 0 },
      },
      {
        planet_id: 'planet-10-2',
        discovered: false,
        kind: 'ice_giant',
        orbit: { distance_au: 3.0, period_days: 1900, inclination_deg: 2 },
      },
    ],
  },
};

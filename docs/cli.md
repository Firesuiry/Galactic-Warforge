...
| `scene` | `[planet_id] <x> <y> <width> <height> [--detail tile\|sector] [--layers a,b]` | 查询 `GET /world/planets/{planet_id}/scene` 原始 JSON |
...
stats
planet
scene planet-1-1 96 160 32 32 --layers terrain,fog,buildings,units,resources

...
- Create: `docs/dev/agent-gateway.md`
...
```bash
cd /home/firesuiry/develop/siliconWorld
git add client-web/src/pages/AgentsPage.tsx client-web/src/features/agents/api.ts docs/dev/client-web.md docs/dev/agent-gateway.md
